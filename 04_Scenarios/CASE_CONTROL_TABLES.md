...
| 個人帳號 | `[每位學員帳號]` | 帳號清單、登入截圖 | `[ ]` |
| 個人聊天區 | `[聊天 / 歷史 / 資料夾]` | 使用者操作截圖 | `[ ]` |
| Admin 管理 | `[Admin / User / Pending]` | Admin Panel 截圖 | `[ ]` |
| 群組權限 | `[部門 / 種子團隊 / Power Users]` | Groups / Permissions 表 | `[ ]` |
| 模型與功能控管 | `[模型、檔案、Web Search、Tools、分享]` | Model access / 功能權限表 | `[ ]` |
| 使用對象 | `[種子人員 / 部門]` | 名單、簽到表 | `[ ]` |
| 可輸入資料 | `[資料類型]` | 資料分級表 | `[ ]` |
| 禁止輸入資料 | `[資料類型]` | AI 使用規範 | `[ ]` |

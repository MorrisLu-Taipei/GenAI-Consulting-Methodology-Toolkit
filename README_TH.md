...
ตำแหน่ง: **n8n Taipei Ambassador / นักศึกษาปริญญาเอก สถาบัน Intelligent Manufacturing, National Taiwan University of Science and Technology (NTUST) / M.IT, Queensland University of Technology (QUT), ออสเตรเลีย**
...
>
> **องค์กรน้อยกว่า 300 คน?** กระบวนการ 8 ขั้นออกแบบสำหรับองค์กรขนาดใหญ่ ใช้ [`00_Overview/SME_LITE_PATH_EN.md`](00_Overview/SME_LITE_PATH_EN.md) **SME Lite Path** (4 ขั้นบีบอัด / USD 10K-50K / 3 เดือน) หรือ **SOHO Path** (2 ขั้น / USD 1.5K-7K / 1 สัปดาห์)
...
| **เจ้าของ SME / SOHO** — วิธีของคุณใช้ได้แค่กับองค์กรใหญ่ใช่ไหม | [`00_Overview/SME_LITE_PATH_EN.md`](00_Overview/SME_LITE_PATH_EN.md) — SME Lite Path เวอร์ชันบีบอัด (4 ขั้น / USD 10K-50K / 3 เดือน) |

...
讓員工透過受控 AI 入口完成高頻知識工作，並理解資料安全與使用邊界。

### 課程大綱

1. AI 成熟度 L1-L5 總覽。
2. OpenWebUI 操作與模型選擇。
3. Prompt 基礎：角色、任務、資料、格式、限制。
4. 文件摘要、Email 草稿、會議紀錄、報告初稿。
5. AI 使用規範：可輸入、不可輸入、需人工確認。
...
L1 課程要避免只教「好玩的 Prompt」。重點是讓客戶看到 AI 可以安全進入日常工作，並為 L2 Skill 化鋪路。

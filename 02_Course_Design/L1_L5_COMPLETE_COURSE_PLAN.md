...
讓員工透過受控 AI 入口，安全使用 AI 完成日常知識工作，並建立企業 AI 使用邊界。
...
| OpenWebUI 操作 | 45 分 | 登入、選模型、對話、檔案、歷史紀錄 | Demo |
...
設計多 Agent 協作模式，讓不同角色 Agent 共同完成跨部門企業級任務。
...
| 單元 | 時間 | 內容 | 方法 |
| --- | ---: | --- | --- |
| Multi-Agent 觀念 | 45 分 | Agent Team 與單一 Agent 差異 | 講授 |
| 角色設計 | 60 分 | 市場、產品、行銷、客服、財務、整合 | 工作坊 |
| 任務分派 | 60 分 | 任務切分、依賴關係、輸入輸出 | 工作坊 |
| 輸出整合 | 60 分 | 整合報告、衝突處理、決策摘要 | 實作 |
| Reviewer / Critic | 45 分 | 品質檢查與風險檢查 | 講授 |
| 治理與 ROI | 45 分 | 權限、Log、Stage Gate、KPI | 講授 |
| Team 演練 | 150 分 | 完成 1 個 Agent Team 案例 | 實作 |

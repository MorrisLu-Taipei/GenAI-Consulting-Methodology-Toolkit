...
| L3 | AI 能跨系統做事，不只回答問題 | n8n Workflow PoC、Execution Log、系統串接表、HITL 人類審核 |
| L4 | Agent 能讀資料、查 Wiki、呼叫工具、產出 briefing，並留下 evidence | Hermes Agent 任務卡、Wiki 紀錄、briefing、驗收關卡 4A-4E |
...
L1-L5 不是「五個工具」，而是**兩條軸**：

- **規模軸（L1 → L2 → L3）**：個人 → 部門 → 跨部門 / 全公司。這三層是「人在迴圈內、人用 AI、人監督 AI」，AI 是工具。
- **AI 自主軸（L4 → L5）**：AI 超級助理 → AI 團隊。這兩層是企業額外長出的數位人力，AI 營運自主；但**治理框架仍由人建立、人保有監督權**，人退為「治理者」而非被取代。
...
- **Stage Gate ＝ 階段驗收關卡** —— 這一級的交付物驗收通過，才進下一級；下文的 Gate 1-5 即各級的階段驗收關卡。
- **HITL ＝ Human-in-the-Loop（人類在迴圈內審核）** —— 流程中保留「人來確認」的關卡，AI 不直接做高風險決定。下文的「人工 Gate」一律即此意。

## 2. 課程總覽

| 等級 | 課程名稱 | 工具 / 平台 | 建議時數 | 核心產出 | Stage Gate |
| --- | --- | --- | ---: | --- | --- |
| L1 | Controlled AI Access — 基礎與企業使用規範 | OpenWebUI | 3-6 小時 | AI 使用規範、Prompt Library、個人效率案例 | Gate 1 |
| L2 | Knowledge Codification — 部門知識沉澱 | Antigravity / Claude Code / Codex | 6-12 小時 | Skill Library、3-5 個 Skill、Owner 與版本 | Gate 2 |
| L3 | Workflow Automation — 跨部門流程自動化 | n8n | 6-18 小時 | n8n Workflow PoC、系統串接表、Log 與審核節點 | Gate 3 |
| L4 | Autonomous Agent — 任務代理 | Hermes Agent | 6-12 小時 | Agent 任務卡、工具清單、權限表、測試紀錄 | Gate 4 |
| L5 | Multi-Agent Organization — 多 Agent 協作 | ClawTeam | 6-12 小時 | Agent Team 角色卡、任務分派、整合報告模板 | Gate 5 |
...
| 執行導入與變革治理 | 45 分 | 權限 (v0.6 roadmap)、Log、Stage Gate、KPI | 講授 |

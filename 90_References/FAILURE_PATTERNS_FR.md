...
**Réponse Tiger AI** : Open-source (Apache 2.0 + GitHub) ; engager proactivement avec les groupes de travail ISO/IEC / discussions IEEE AI Maturity standards ; construire de la recherche conjointe avec QUT, NTUST.

...
> 10 題、約 3 分鐘。協助您 quickly 看出企業 AI 成熟度落點 (L1-L5)。填寫後 24 hr 內收到客製化解讀。
> 10 questions, ~3 minutes. Quickly see your enterprise AI maturity level. Custom report delivered within 24 hours.
...
| Q | 題目 | 構面 |
| --- | --- | --- |
| Q1 | 我們員工普遍每天使用 AI 工具完成工作 | 工具使用 |
| Q2 | 員工的 Prompt 與經驗有集中整理 | 知識沉澱 |
| Q3 | 我們有定義「什麼是好的 AI 使用方式」 | 流程標準化 |
| Q4 | AI 已串接我們至少一個企業系統 (Gmail / Sheets / CRM / ERP) | 系統整合 |
| Q5 | 我們有可重複呼叫的 AI Skill 或 Workflow | Agent 應用 |
| Q6 | 我們有 AI 使用規範與 Audit 機制 | 治理 ROI |
| Q7 | AI 對我們的工作效率有具體可量化成果 | ROI |
| Q8 | 我們有 AI 升級的清楚下一步 (而非靠工具廠商) | 戰略 |
| Q9 | 主管會定期檢視 AI 導入進度 | 治理 |
| Q10 | 我們對 AI 風險 (資安、合規、幻覺) 有具體防護 | 治理 |
...
> 25 題、約 8 分鐘。比 10 題版更深入：每個構面 4-5 題。建議在 L1 課程開課前 1 週由全公司主管填寫。
> 25 questions, ~8 minutes. Deeper than 10-Q: 4-5 questions per construct. Recommended to be completed by managers one week before L1 course delivery.
...
> 50 題、約 20 分鐘。建議在顧問訪談前由 IT / AI Champion 完成。涵蓋六構面 + 部署模式 + 系統盤點 + 治理。

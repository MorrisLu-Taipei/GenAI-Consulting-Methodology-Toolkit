...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20261680.svg)](https://doi.org/10.5281/zenodo.20261680) [![Paper DOI](https://img.shields.io/badge/Paper%20DOI-10.5281%2Fzenodo.20261850-blue.svg)](https://doi.org/10.5281/zenodo.20261850) [![License: Apache 2.0](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](LICENSE)
...
> 系列只有一個,書才分 I/II(勿寫「Series II」)。先看系列總入口 **[`SERIES_INDEX.md`](SERIES_INDEX.md)**／[EN](SERIES_INDEX_EN.md),視覺地圖 [`SERIES_ROADMAP.html`](SERIES_ROADMAP.html),名詞與流程以 **[`CANONICAL_TERMS_AND_MAPS.md`](CANONICAL_TERMS_AND_MAPS.md)** 為準。

作者：**Morris (Yeh-Hsing) Lu(盧業興)**｜affiliation: **Tiger AI**｜ORCID 0009-0006-5373-0586  
...
>
> **組織 < 300 人？** 八階段是 enterprise 設計，請走 [`00_Overview/SME_LITE_PATH.md`](00_Overview/SME_LITE_PATH.md) **SME Lite Path**（4 階段壓縮 / 30-150 萬 / 3 個月）或 **SOHO Path**（2 階段 / 5-20 萬 / 1 週）。

> 📘 **你是新手顧問？先讀「上集」。** 本工具包是**Book II（從顧問判斷到專案交付）**，**假設你已具備基本顧問判斷能力**。若你還停在「會議紀錄」層、交不出判斷與對角線，請先完成 **Book I：顧問思考能力系統**（[`10_Thinking_Framework/`](https://github.com/MorrisLu-Taipei/consultant-thinking-framework)，從會議紀錄到顧問判斷），再進入本套完整專案導入流程。兩集關係見 [`10_Thinking_Framework/22_Bridge_To_Consulting_Delivery.md`](https://github.com/MorrisLu-Taipei/consultant-thinking-framework/blob/main/22_Bridge_To_Consulting_Delivery.md)。
...
| 您是 | 從這份開始 |
| --- | --- |
| **研究者 / 非技術讀者** ── 想看人類與 AI 如何共同研究成熟度理論 | [`09_Research_Paper/AI_MATURITY_HUMAN_AI_RESEARCH_STORY_ZH.md`](09_Research_Paper/AI_MATURITY_HUMAN_AI_RESEARCH_STORY_ZH.md) — 第二情境：Morris 將成熟度經驗轉成可反駁、可驗證的 Paper #2 |
...
| **中小企業老闆 / SOHO 工作者** ── 你方法是不是只能服務大公司 | [`00_Overview/SME_LITE_PATH.md`](00_Overview/SME_LITE_PATH.md) — SME Lite Path 壓縮版（4 階段 / 30-150 萬 / 3 個月） |

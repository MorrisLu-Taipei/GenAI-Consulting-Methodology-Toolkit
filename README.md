...
| L4 | Auto Agentic AI | Hermes Agent | 可自動拆解任務、呼叫工具、執行流程、回報結果 |
...
| [`02_Course_Design`](02_Course_Design/) | L1-L5 完整課程規劃、公司屬性、部署模式 |
...
5. [`04_Scenarios/CASE_CONTROL_TABLES.md`](04_Scenarios/CASE_CONTROL_TABLES.md)
6. [`03_Consulting_Report/CONSULTING_REPORT_TEMPLATE.md`](03_Consulting_Report/CONSULTING_REPORT_TEMPLATE.md)

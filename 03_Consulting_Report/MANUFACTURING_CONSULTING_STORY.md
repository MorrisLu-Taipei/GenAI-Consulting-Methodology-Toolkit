...
| **IT 現況** | IT 協理 1 人主管，2 名 IT FTE，ERP（XYZ ERP，虛構系統名）+ MES（自製）+ CRM（無）|
...
**早上 9:00**，Tiger AI 顧問張顧問與老明、IT 協理林協理坐在明昌會議室。
...
| COO 王副總 | 60 分鐘 | 同上 | 「跨部門協作最大瓶頸在哪？」|
| IT 協理林 | 60 分鐘 | 同上 | 「IT 預算、人力、現有系統？」|
...
張顧問與林協理一起列出**所有員工用過的 AI 工具**（包括私下）：
...
老明帶著明昌核心幹部 7 人（CEO + COO + IT 協理 + QC / Sales / CS / HR 部長）開會。

**會議流程**：
1. 張顧問播放雷達圖 → 全場沉默 30 秒
2. COO 翻 Swimlane：「我們的投訴流程真的有這些洞……」
3. IT 協理看 Shadow IT 表：「私下 ChatGPT 月燒 4 萬 2，資料邊界不明……」
...
**參加人**：CEO 老明、COO 王副總、IT 協理林、QC / Sales / CS / HR 4 位部長 — **共 7 人**。
...
- 「IT 只有 2 FTE，Phase 2 整合 ERP 來得及嗎？」→ 林協理：「來不及，至少要 +0.5」
...
| AI Champion | 4 | 老明 + 王 COO + 林協理 3 人到位 |
...
**Day 23 晚，張顧問與老明、林協理**開會：

- 張顧問：「林協理，你 2 名 IT 能多撐 0.5 FTE 嗎？」
- 林協理：「不行，我們連 ERP 維運都來不及。」
- 老明：「那要不要外包？」
...
>
> **這就是科學管理**。我女兒在某大學資管系說，這是 Rosemann BPM 學派 + Max Weber 的科學管理在現代的落地。」
